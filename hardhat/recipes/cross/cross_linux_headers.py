...
# work on x64 when the actual kernel is 2.6.32 or better, except on Intel
    ...
    ('3.10.107',
     'ed1a79a34731b2318429bb54c71b186f18bcf0692eb7bd12b19465ef1daf4658',
     'https://cdn.kernel.org/pub/linux/kernel/v3.x/linux-3.10.107.tar.gz'),
    ('4.1.24',
    ...
    ('4.16.5',
     '72d25ca2fa54919724b5a59b785a0e47ecc66a03d0df176696d393a19b4c5941',
     'http://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.16.7.tar.gz')
]
